...
def federated_averaging(state_dicts):
    ...
    avg_state = {}
    # Initialisierung mit Schlüsseln des ersten Modells
...
def build_global_val_loader(all_fed_loaders, batch_size=32):
    ...
    # Alle Subclients eines Basis-Clients (z.B. client_1_sub_1 bis client_1_sub_4)
    # nutzen selbes disjunktes Validierungsset -> nehmen jeweils nur das Set vom ersten Subclient einer Gruppe.
    ...
    return DataLoader(
        ...
        shuffle=False,
        drop_last=True  # Gegen Fehler der Batch-Dimension im Quantum-Layer
    )